...
export default function GameLobby() {
    ...
    const [gameCode, setGameCode] = useState(gameCodeSpecifiedInURL? searchParams.get("gameCode") : null)
    ...
    if (!gameCodeSpecifiedInURL) {
        ...
        elementToRender = <Lobby gameCode={gameCode}/>
    }
