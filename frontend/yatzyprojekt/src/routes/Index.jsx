...
export default function Index() {
    ...
    let [currentElement, setCurrentElement] = useState(cookies.rulePromptShown === undefined ? rulePrompt: gameModePrompt)
    let elementToRender = null
    // Nedan renderas de olika elementen.
    const onRulePromptShown = ()=>{ // Funktion som körs när användaren visat reglerna eller tackat nej till att visa de
