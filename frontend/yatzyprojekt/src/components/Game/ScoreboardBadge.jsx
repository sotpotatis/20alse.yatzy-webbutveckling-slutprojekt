...
export default function ScoreBoardBadge({
    textSize, points, picked, picking, isPickable, onClick
}) {
    ...
    else { // Om "badgen" inte är involverat i poängplocking ska den alltid vara blå.
        badgeColor = "blue"
    }
    return <Badge text={`${points}p`} additionalClasses={textSizeClass + " " + otherClases}
    color={badgeColor} onClick={onClick}/>
