...
export default function ScoreboardExpandButton({isCollapsed, setCollapsed}){
    ...
    return <Button text="" color="gray" icon={iconName} additionalClasses="invisible md:visible absolute right-0 top-1/2 z-30 border-2 border-gray-800 w-min h-min text-2xl rounded-r-none shadow-sm" circle={true}
