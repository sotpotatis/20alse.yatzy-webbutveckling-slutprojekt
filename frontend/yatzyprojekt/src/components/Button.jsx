...
const colors = {
  // Definera färgerna på ram och bakgrund för olika knappar
...
export default function Button({
  ...
  // Lägg till gömd text om någon (detta är för skärmläsare)
  ...
  return (
    <button
      ...
      className={`font-semibold ${
        color !== "link" ? "border-2" : ""
      } px-3 py-3 hover:cursor-pointer disabled:opacity-50 ${colorClassesToApply} ${additionalClasses} ${otherClassesToApply}`}
    >
      {icon}
      {text}
      {screenReaderText}
