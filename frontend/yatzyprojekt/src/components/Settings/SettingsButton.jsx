...
export default function SettingsButton(props){
    ...
    let children = [<div key="settingsButton" role={"button"} className="absolute static text-white bg-blue-400 shadow-lg max-w-min right-0 bottom-0 p-4 m-12 rounded-full text-3xl z-10"
