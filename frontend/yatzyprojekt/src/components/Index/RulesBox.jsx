  ...
  const children = [
    ...
    <RulesBoxSection
      ...
      children={[
        ...
        <p>
          I Yatzy ingår 5 stycken tärningar. Spelet spelas i turordning där
          varje spelare har maximalt 3 tärningskast per tur. Man kan välja att
          avsluta sin tur tidigare, dvs. efter 1 eller 2 kast om man vill.
        </p>,
        <Heading level={3} size={4}>
          Spara tärningar
        </Heading>,
        <p>
          ...
          implementation så klickar du på en tärning för att spara den. Detta
          kommer innebära att endast de osparade tärningarna kommer kastas om
          nästa gång. På så sätt kan du tänka strategiskt och få högre poäng på
          något av spelets <i>kombinationer</i>.
        </p>,
        <Heading level={3} size={4}>
